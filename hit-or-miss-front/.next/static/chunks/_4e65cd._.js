(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_4e65cd._.js", {
...
const io = __turbopack_require__("[project]/node_modules/socket.io-client/build/cjs/index.js [app-client] (ecmascript)")(3001, {
    cors: {
        origin: "http://localhost:3000",
        methods: [
            "GET",
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].on('connection', (socket)=>{
...
const QuizGame = ()=>{
    ...
    // }, []);
    const joinRoom = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$socket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].emit('joinRoom', {
            roomId,
            username
        });
    };
    const sendAnswer = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$socket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].emit('chat message', {
            answer
        });
    };
...
//# sourceMappingURL=_4e65cd._.js.map